...
public class Main {
	...
	public static void main(String[] args) {
		...
		spike.idade = 13;
			...
			System.out.println("Ele está correndo ! " + spike.correr() + "\n");
		...
		Cavalu.idade = 19;
			...
			System.out.println("Ele está correndo ! " + Cavalu.correr() + "\n");
		...
		flashmark2.idade = 5;
			...
			System.out.println("Ele está correndo ! " + flashmark2.correr() + "\n");
